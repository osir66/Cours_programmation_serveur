...
@router.get("/getListSalles", summary="Récupérer la liste de toutes les salles")
def get_list_salles():
    return salleController.getListSalles()

# Route pour ajouter une salle
@router.post("/createSalle", summary="Ajouter une salle")
...
@router.put("/updateSalle/{id_salle}", summary="Modifier une salle")
...
@router.delete("/deleteSalle/{id_salle}", summary="Supprimer une salle")
